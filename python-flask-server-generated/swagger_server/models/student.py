...
from swagger_server.models.student_grade_records import StudentGradeRecords  # noqa: F401,E501
...
class Student(Model):
    ...
    """
    def __init__(self, student_id: float=None, first_name: str=None, last_name: str=None, grade_records: List[StudentGradeRecords]=None):  # noqa: E501
        ...
        :type grade_records: List[StudentGradeRecords]
        """
        self.swagger_types = {
            'student_id': float,
            'first_name': str,
            'last_name': str,
            'grade_records': List[StudentGradeRecords]
        }
    ...
    @property
    def grade_records(self) -> List[StudentGradeRecords]:
        """Gets the grade_records of this Student.


        :return: The grade_records of this Student.
        :rtype: List[StudentGradeRecords]
        """
        return self._grade_records

    @grade_records.setter
    def grade_records(self, grade_records: List[StudentGradeRecords]):
